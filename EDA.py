...
cdb_i_ct_rlps = spark.sql('SELECT * FROM hive_metastore.pg_vw.cdb_i_ct_rlps')  # 계약관계자정보
cdb_i_ct_cont_pvt = spark.sql('SELECT * FROM hive_metastore.pg_vw.cdb_i_ct_cont_pvt')  # 보험계약정보
